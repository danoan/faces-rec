...
public:
    ...
    static int CLASSIFIER_FACES_TRAINING_SET_SIZE;
    static int CLASSIFIER_FACES_VALIDATION_SET_SIZE;
    static int CLASSIFIER_SCENES_TRAINING_SET_SIZE;
    static int CLASSIFIER_SCENES_VALIDATION_SET_SIZE;
    static int CLASSIFIER_SCENES_CROPS_FIRST_CLASSIFIER;

    static int CLASSIFIER_MAX_HYPOTHESIS_PER_STAGE;
    static int CLASSIFIER_SCENE_CROP_PER_IMAGE;

    static int CLASSIFIER_INTEGRAL_IMAGE_BUFFER_SIZE;
    static bool CLASSIFIER_HAS_BUFFER;

    static int CLASSIFIER_SET_CROP_BUFFER_SIZE;
