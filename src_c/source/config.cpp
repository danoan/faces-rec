...
int Config::CLASSIFIER_SHIFT_STEP = 2;
double Config::CLASSIFIER_RESIZE_FACTOR = 1.25;
int Config::CLASSIFIER_SUBWINDOW_START_WIDTH = 8;
int Config::CLASSIFIER_SUBWINDOW_START_HEIGHT = 8;
...
int Config::MAX_LENGHT_VALIDATION_SET = 200;
...
std::string Config::TRAINING_FACES_TEST_PATH =  TRAINING_IMG_PATH + "/test_faces";    
std::string Config::TRAINING_SCENES_TEST_PATH = TRAINING_IMG_PATH + "/test_non_faces";

std::string Config::VALIDATION_FACES_TEST_PATH = VALIDATION_IMG_PATH + "/test_faces";
std::string Config::VALIDATION_SCENES_TEST_PATH = VALIDATION_IMG_PATH + "/test_non_faces";        
