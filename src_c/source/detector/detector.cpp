...
void Detector::detectFaces(ClassifierInterface* ci, const std::string img_path, double ac){	
...
void Detector::detectFaces(ClassifierInterface* ci, const std::string img_path){
	detectFaces(ci,img_path,-1.0);	
}
